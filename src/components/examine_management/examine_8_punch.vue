          ...
          <el-form :model="auditflow0" label-width="">
            <el-form-item label="员工名称 :">
             ...
             <el-form-item label="审核人名称 :">
              ...
              <el-input v-model="auditflow0.cardType" disabled></el-input>
            </el-form-item>
                <el-form-item label="补打卡日期 :">
              <el-input v-model="auditflow0.cardDate" disabled></el-input>
            </el-form-item>
            <el-form-item label="补打卡备注 :">
              <el-input v-model="auditflow0.cardRemarks" disabled></el-input>
            </el-form-item>
...
export default {
  ...
  methods: {
    ...
    selectById(row) {
      ...
      //根据id查询
      this.axios
          .get("http://localhost:8010/provider/findSelectCardById/" + row.auditflowId)
          .then((response) => {
