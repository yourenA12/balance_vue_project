        ...
        >
          ...
          <el-table-column label="操作">
            <template #default="scope">
              ...
              <el-button type="text" @click="selectById(scope.row)">详情1 </el-button>
          ...
          <el-form :model="auditflow0" label-width="">
            <el-form-item label="员工名称 :">
             ...
             <el-form-item label="审核人名称 :">
              ...
              <el-input v-model="auditflow0.auditflowType" disabled></el-input>
            </el-form-item>
                <el-form-item label="请假开始时间 :">
              <el-input v-model="auditflow0.leaveSDate" disabled></el-input>
            </el-form-item>
              <el-form-item label="请假结束时间 :">
              <el-input v-model="auditflow0.leaveEDate" disabled></el-input>
            </el-form-item>
            <el-form-item label="请假总小时 :">
              <el-input v-model="auditflow0.leaveTotalDate" disabled></el-input>
            </el-form-item>
            <el-form-item label="请假事由 :">
              <el-input v-model="auditflow0.leaveRemarks" disabled></el-input>
            </el-form-item>
...
export default {
  ...
  methods: {
    ...
    selectById(row) {
      ...
      //根据id查询
      this.axios
          .get("http://localhost:8010/provider/findeSeelectById/" + row.auditflowId)
          .then((response) => {
            console.log(response);
