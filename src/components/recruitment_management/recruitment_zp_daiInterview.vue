...
<!--        <el-table-column prop="invitation" label="是否邀约" width="140"/>-->
        ...
        <el-table-column fixed="right" label="操作" width="180">
          <template #default="scope">
            <div style="width: 110px">
              <el-button type="text" size="small" @click="Fxiugai(scope.row)">安排复试</el-button>
              <el-row class="block-col-2" style="float: right;">
                ...
                <span class="el-dropdown-link">
                  <el-button type="text" size="small">更多<i class="iconfont" style="font-size: 10px">&#xe772;</i></el-button>
                    ...
                    <template #dropdown>
                      <el-dropdown-menu>
                        <el-dropdown-item @click="Txiugai(scope.row)">放弃/淘汰</el-dropdown-item>
                        <el-dropdown-item @click="MTxiugai(scope.row)">面试通过</el-dropdown-item>
                      </el-dropdown-menu>
                    </template>
                  </el-dropdown>
                </el-col>
      ...
      <div class="demo-pagination-block">
        ...
        <el-pagination
            ...
            :pager-count="5"
            background
            @size-change="selectdailnterview_plan"
            @current-change="selectdailnterview_plan"
        >
        </el-pagination>
      </div>
    </div>
...
export default {
  ...
  methods:{
    selectdailnterview_plan(){
      this.axios
          .get("http://localhost:8010/provider/ResumeVo/ResumePage_Z/"+this.pageInfo.currenPage+"/"+this.pageInfo.pagesize)
          .then((response) => {
    ...
    MTxiugai(row){
      ...
      this.Mfo.resumeId=row.resumeId

      this.axios
          .put("http://localhost:8010/provider/resume/resume/zeliminate",this.Mfo)
          .then((response) => {
