...
<!--        <el-table-column prop="invitation" label="是否邀约" width="140"/>-->
      ...
      <div class="demo-pagination-block">
        ...
        <el-pagination
            ...
            :pager-count="5"
            background
            @size-change="selectdaiSecondInterview_plan"
            @current-change="selectdaiSecondInterview_plan"
        >
        </el-pagination>
      </div>
    </div>
...
export default {
  ...
  methods:{
    selectdaiSecondInterview_plan(){
      this.axios
          .get("http://localhost:8010/provider/ResumeVo/ResumePage_F/"+this.pageInfo.currenPage+"/"+this.pageInfo.pagesize)
          .then((response) => {
